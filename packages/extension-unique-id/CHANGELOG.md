...
- db873d9: Add support for `types: 'all'` in `UniqueID` to target every node type except `doc` and `text`.
...
- 1df8901: Add `updateDocument` option to disable document updates caused by the Unique ID extension.
