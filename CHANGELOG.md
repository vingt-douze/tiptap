...
- d9d2bb6: Nested lists exported to Markdown now keep their hierarchy when the file is read back by other Markdown tools.
- d9d2bb6: Fix a denial-of-service risk where crafted block or inline Markdown attributes could consume excessive CPU and block the browser or server event loop.
- d9d2bb6: Fix freezes in framework-based node views on iOS and Android
- d9d2bb6: Prevent untrusted HTML attributes from changing an object's prototype when merged with `mergeAttributes`.
...
- d9d2bb6: Pasting a YouTube iframe without a `src` attribute no longer crashes the editor. The embed is kept without a source.
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
...
- d9d2bb6: StarterKit no longer installs the deprecated `@tiptap/extension-dropcursor`, `@tiptap/extension-gapcursor`, `@tiptap/extension-list-item`, and `@tiptap/extension-list-keymap` packages. We will not publish further updates to these packages. StarterKit still includes their extensions, so you do not need to change your configuration.
...
- d9d2bb6: Fix Markdown serialization of whitespace-only marked text.
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
...
- d9d2bb6: Align `selected` with ProseMirror node selections by default, expose text selections through `selectionInside`, and keep `selectedOnTextSelection` compatible.

#### Patch Changes

- d9d2bb6: Reduce overhead in React node views on documents with many nodes.
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
- Updated dependencies [d9d2bb6]
...
- d9d2bb6: Vue 2 support is removed. `@tiptap/vue-3` is now `@tiptap/vue`, and `@tiptap/extension-drag-handle-vue-3` is now `@tiptap/extension-drag-handle-vue`.
